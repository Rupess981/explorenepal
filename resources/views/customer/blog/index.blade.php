            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="news_container">
                        ...
                        <!-- News Post -->
                        <div class="news_post">
                            <div class="news_post_image"><img src="{{asset('customerasset/images/news_4.jpg')}}" alt=""></div>
                        ...
                        <!-- News Post -->
                        <div class="news_post">
                            <div class="news_post_image"><img src="{{asset('customerasset/images/news_5.jpg')}}" alt=""></div>
                            <div class="news_post_content">
                                <div class="news_post_date d-flex flex-row align-items-end justify-content-start">
                                    <div>02</div>
                                    <div>june</div>
                        ...
                        <!-- News Post -->
                        <div class="news_post">
                            <div class="news_post_image"><img src="{{asset('customerasset/images/news_6.jpg')}}" alt=""></div>
                            <div class="news_post_content">
                                <div class="news_post_date d-flex flex-row align-items-end justify-content-start">
                                    <div>02</div>
                                    <div>june</div>
                ...
                <div class="col-lg-4">
                    <div class="news_sidebar">
                        ...
                        <div class="latest">
                            ...
                            <div class="latest_container">
                                ...
                                <div class="latest_post d-flex flex-row align-items-start justify-content-start">
                                    <div class="latest_post_image"><img src="{{asset('images/latest_1.jpg')}}" alt=""></div>
                                ...
                                <!-- Latest Post -->
                                <div class="latest_post d-flex flex-row align-items-start justify-content-start">
                                    <div class="latest_post_image"><img src="{{asset('customerasset/images/latest_2.jpg')}}" alt=""></div>
                                    <div class="latest_post_content">
                                        <div class="latest_post_date d-flex flex-row align-items-end justify-content-start">
                                            <div class="latest_post_day">02</div>
                                            <div class="latest_post_month">june</div>
                                ...
                                <!-- Latest Post -->
                                <div class="latest_post d-flex flex-row align-items-start justify-content-start">
                                    <div class="latest_post_image"><img src="{{asset('customerasset/images/latest_3.jpg')}}" alt=""></div>
                                    <div class="latest_post_content">
                                        <div class="latest_post_date d-flex flex-row align-items-end justify-content-start">
                                            <div class="latest_post_day">02</div>
                                            <div class="latest_post_month">june</div>
                        ...
                        <div class="travello">
                            <div class="background_image" style="background-image:url({{asset('customerasset/images/travello.jpg')}})"></div>
